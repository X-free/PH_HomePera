...
@interface GworkBackController ()<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate,OPhNavigationBackButtonDelegate>
...
@implementation GworkBackController
...
- (void)viewDidLoad {
    ...
    [[NetworkManager sharedManager] POST:@"/radiating/kyoto"
...
-(void)confirmButtonTapped{
    ...
    [[NetworkManager sharedManager] POST:@"/radiating/looking"
...
-(void)cradiatingButtonTomomi{
    ...
    [[NetworkManager sharedManager] POST:@"/radiating/tomomi"
        ...
        if([responseObject[@"heavy"] isEqualToString:@"0"]){
           ...
           if ([species[@"pensive"] isEqualToString:@"cupersuchousI"]){
...
-(void)locaRadiatingPermis:(NSMutableDictionary*)permis{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSDictionary *medis = @{
            ...
            @"bill": @"6",         // 看文档首页 上报场景类型：1、注册 2、认证选择 3、证件信息 4、人脸照片 5、个人信息 6、工作信息 7、紧急联系人 8、银行卡信息9、开始申贷 10、结束申贷
